...
Java_com_cgwang1580_senioropengles_MyGLRenderer_onSurfaceCreatedJNI(JNIEnv *env, jobject thiz)
{
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cgwang1580_senioropengles_MyGLRenderer_onSurfaceChangedJNI(JNIEnv *env, jobject thiz, jint width, jint height)
{
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cgwang1580_senioropengles_MyGLRenderer_onDrawFrameJNI(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jint JNICALL
Java_com_cgwang1580_senioropengles_MyGLRenderer_onSurfaceDestroyedJNI(JNIEnv *env, jobject thiz)
{
