...
{
public:
	Mesh (const vector <Vertex> vertices, const vector<GLuint> indices, const vector<Texture> texture);
...
Mesh::Mesh(const vector<Vertex> vertices, const vector<GLuint> indices, const vector<Texture> texture)
{
	LOGD("Mesh::Mesh");
	...
	m_vIndices = vector <GLuint > (indices);
...
void Mesh::DrawMesh(ShaderHelper *pShaderHelper)
{
	LOGD("Mesh::DrawMesh");
